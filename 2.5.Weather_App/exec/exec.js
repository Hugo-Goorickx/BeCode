...
let x = 0;
let tmpGlobal = [];
let input = document.getElementById('allCity');
...
function convertDayByDay(listTmp, stock)
{
    let compteur = 0,
        totalTemp = 0,
        actuelle = "",
...
async function catchData()
{
    ...
    convertDayByDay(listTmp, stock);
    genWeather();
}

document.getElementById("genForm").addEventListener('click', function(){catchData()})